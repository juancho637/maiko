        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>{{ ucfirst(__("crear cliente")) }}</h4>
                    <div class="card-header-action">
                        ...
                        <div class="breadcrumb-item">{{ ucfirst(__("crear cliente")) }}</div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('dashboard.companies.clients.store', $company) }}">
                        <div class="row">
                            @csrf
