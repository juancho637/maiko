                    ...
                    <form method="POST" action="{{ route('dashboard.work_orders.update', $work_order) }}">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 {{ $errors->has('duration') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="duration" name="duration" value="{{ old('duration', $work_order->duration) }}" class="form-control" {{ $errors->has('duration') ? 'autofocus' : '' }}>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('feeding') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="feeding" name="feeding" value="{{ old('feeding', $work_order->feeding) }}" class="form-control" {{ $errors->has('feeding') ? 'autofocus' : '' }}>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('hotel') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="hotel" name="hotel" value="{{ old('hotel', $work_order->hotel) }}" class="form-control" {{ $errors->has('hotel') ? 'autofocus' : '' }}>
