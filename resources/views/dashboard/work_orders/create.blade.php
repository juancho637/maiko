                    ...
                    <form method="POST" action="{{ route('dashboard.work_orders.store') }}">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('invoice_name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="invoice_name" name="invoice_name" value="{{ old('invoice_name') }}" class="form-control" {{ $errors->has('invoice_name') ? 'autofocus' : '' }}>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('invoice_nit') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="invoice_nit" name="invoice_nit" value="{{ old('invoice_nit') }}" class="form-control" {{ $errors->has('invoice_nit') ? 'autofocus' : '' }}>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('invoice_contact_name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="invoice_contact_name" name="invoice_contact_name" value="{{ old('invoice_contact_name') }}" class="form-control" {{ $errors->has('invoice_contact_name') ? 'autofocus' : '' }}>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('invoice_mail') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="invoice_mail" name="invoice_mail" value="{{ old('invoice_mail') }}" class="form-control" {{ $errors->has('invoice_mail') ? 'autofocus' : '' }}>
