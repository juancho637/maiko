...
class WorkOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'invoice_name' => 'required|string|max:191',
            'invoice_nit' => 'required|string|max:191',
            'invoice_contact_name' => 'required|string|max:191',
            'invoice_mail' => 'required|string|max:191',
            'r_mkc_002' => 'boolean',
            'r_mkc_031' => 'boolean',
            'r_mkc_032' => 'boolean',
            'r_mkc_033' => 'boolean',
