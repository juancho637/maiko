...
class QuestionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta placa de identificacion, legible y que corresponde al tanque', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'Las tuercas y espárragos están en buenas condiciones', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta oxidacion visible', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta corrosión general', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta corrosion aislada', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta corrosion en linea', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presentan grietas, fisuras o escapes', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta abolladuras', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta abombamientos', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta daños o evidencias de accion del fuego', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta daños o defectos en sus bridas', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'Las roscas y conexiones del tanque estan en buen estado', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'Las soldaduras del tanque se evidencian lisas, de aspecto uniforme', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'Las soldaduras del tanque evidencian poros, agrietamientos, salpicaduras o socavado', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'Los soportes y los sobresanos se encuentran en buen estado', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'Se evidencian defectos  resanados con masilla, polimeros, epoxicos o pinturas', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'La Pintura del tanque se encuentra en buenas condiciones', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El indicador de Presion y nivel se encuentran en buen estado y operan correctamente', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El indicador de temperatura se encuentran en buen estado y opera correctamente', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'El tanque presenta algun tipo de fuga', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'Las valvulas de globo y cierre rapido operan correctamente', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
        Question::create(['module' => 'inspección extrena', 'question' => 'Las tuberias que se conectan al tanque se encuentran en buen estado', 'response_type' => 'opción múltiple con respuesta única', 'possible_response' => 'SI,NO,N/A']);
